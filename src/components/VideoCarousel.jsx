            ...
            <div className='video-carousel_container'>
              <div className='w-full h-full flex-center rounded-3xl overflow-hidden bg-black'>
                <video
                  ...
                  onEnded={() => (i !== 4 ? handleProcess("video-end", i) : handleProcess("video-last"))}
                >
              ...
              <div className='absolute mx-auto top-[49%] left-[46%] rounded-xl btn whitespace-nowrap'>
              <Link to={list.linkTo} className="text-black font-semibold">Learn More</Link>
            </div>
            </div>
          </div>
        ))}
